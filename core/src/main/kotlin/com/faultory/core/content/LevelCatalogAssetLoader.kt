...
class LevelCatalogAssetLoader(resolver: FileHandleResolver) :
    AsynchronousAssetLoader<LevelCatalog, LevelCatalogAssetLoader.Parameters>(resolver) {

    class Parameters : AssetLoaderParameters<LevelCatalog>()

    private var decoded: LevelCatalog? = null
    ...
    override fun loadSync(manager: AssetManager, fileName: String, file: FileHandle, parameter: Parameters?): LevelCatalog {
